...
RUN cargo chef cook --release --target x86_64-unknown-linux-musl --recipe-path recipe.json --features web_api
COPY . .
RUN cargo build --release --target x86_64-unknown-linux-musl --features web_api
