...
export interface paths {
    ...
    "/api/config/max_watching": {
        ...
        get: operations["get_max_watching"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/config/max_watching/": {
        ...
        get?: never;
        put?: never;
        post: operations["update_max_watching"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface operations {
    ...
    get_max_watching: {
        ...
        requestBody?: never;
        responses: {
            /** @description Get the maximum number of streams to watch */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    update_max_watching: {
        ...
        responses: {
            /** @description Successfully updated max_watching */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    get_logs: {
        ...
        requestBody?: never;
        responses: {
            /** @description Get last logs as rendered html */
            200: {
                headers: {
                    [name: string]: unknown;
                };
